...
func (o *ListMTOShipmentsOK) WithPayload(payload ghcmessages.MTOServiceItems) *ListMTOShipmentsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list m t o shipments o k response
func (o *ListMTOShipmentsOK) SetPayload(payload ghcmessages.MTOServiceItems) {
	o.Payload = payload
}
